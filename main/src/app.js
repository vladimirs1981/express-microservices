...
(0, typeorm_1.createConnection)().then(function (db) {
    var productRepo = db.getMongoRepository(product_1.Product);
    amqp.connect(process.env.AMQP_URI, function (err0, connection) {
        if (err0) {
            throw err0;
        }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, productRepo.deleteOne({ admin_id: admin_id })];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productRepo.findOne({
                                where: { _id: new mongodb_1.ObjectId(req.params.id) },
                            })];
                        case 1:
                            product = _a.sent();
                            console.log(product);
                            return [4 /*yield*/, axios.post("http://localhost:8000/api/products/".concat(product.admin_id, "/like"), {})];
                        case 2:
                            _a.sent();
                            product.likes++;
                            return [4 /*yield*/, productRepo.save(product)];
